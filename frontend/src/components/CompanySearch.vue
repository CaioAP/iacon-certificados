      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container-fluid">
            <div class="row">
              <section-modal :flex="true" f-justify="center" f-align="center">
                <form-input
                  col-size="2"
                  label-text="Código"
                  input-type="number"
            ...
            <div class="row">
              <div class="col-12">
                ...
                <table
                  :id="`table-${modalId}`"
                  class="table table-hover table-selectable table-responsive-md hover stripe"
                  width="100%"
                ></table>
              </div>
            </div>
  ...
  methods: {
    ...
    filterCompaniesTable(attr, data) {
      ...
      this.filtered = this.companies.filter(
        (company) => String(company[attr]).indexOf(data) > -1
      )
    },
      ...
      for (let i = 0; i < selected.length; i++) {
        ...
        if (
          this.selectedCompanies.filter(
            (company) => company.codigo === sel.codigo
          ).length === 0
        )
